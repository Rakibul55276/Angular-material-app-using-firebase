...
export const environment = {
  production: false,
  firebase: {
    apiKey: "AIzaSyBb9bVFiXhRFC1uWNfJl_8wUxdcsZPPzaY",
    authDomain: "ng-fitnesstracker-4ec72.firebaseapp.com",
    databaseURL: "https://ng-fitnesstracker-4ec72.firebaseio.com",
